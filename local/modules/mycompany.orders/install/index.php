...
Битрикс CModule*/
Class mycompany_orders extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "mycompany.orders";
    var $MODULE_ID = "mycompany.orders";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("mycompany.orders_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("mycompany.orders_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("mycompany.orders_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("mycompany.orders_PARTNER_URI");
    }
